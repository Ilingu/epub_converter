...
fn build_i_dont_want_this_reincarnation() -> epub_builder::Result<()> {
...
fn main() {
    build_i_dont_want_this_reincarnation()
        .expect("Failed to build epub for 'i_dont_want_this_reincarnation'");
}
